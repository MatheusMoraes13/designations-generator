...
public class MunicipalitiesController {
    ...
    @PostMapping
    public ResponseEntity<?> registerMunicipalities(@RequestBody Municipalities municipalities){
        return municipalitiesService.registerMunicipalities(municipalities);
    }
